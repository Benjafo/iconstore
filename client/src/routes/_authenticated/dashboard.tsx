    ...
    <div className="page-container">
      <Section spacing="lg">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
          ...
          <Card className="card-elevated animate-slide-up">
            ...
            <CardContent className="space-y-3">
              <div className="flex justify-between items-center">
                ...
                <Text size="sm" weight="medium">{user?.username}</Text>
              </div>
              <div className="flex justify-between items-center">
          ...
          <Card className="card-elevated animate-slide-up" style={{ animationDelay: '0.1s' }}>
            ...
            <CardContent>
              <div className="flex items-baseline gap-2">
                <Text size="xl" weight="bold" className="text-2xl text-green-600 dark:text-green-400">
                  ${user?.currency_balance || 0}
                </Text>
                <Text size="sm" color="muted">credits</Text>
              </div>
          ...
          {/* Quick Actions Card */}
          <Card className="card-elevated animate-slide-up md:col-span-2 lg:col-span-1" style={{ animationDelay: '0.2s' }}>
            <CardHeader>
              <CardTitle className="text-card-title flex items-center gap-2">
